var Notyf = function () {
    ...
    var e, t, o = function () {
        return (o = Object.assign || function (t) {
            for (var i, n = 1, e = arguments.length;
                n < e;
                n++)for (var o in i = arguments[n]) Object.prototype.hasOwnProperty.call(i, o) && (t[o] = i[o]);
            return t
    ...
    (t = e = e || {
    })[t.Add = 0] = "Add", t[t.Remove = 1] = "Remove";
    ...
    function n() {
        ...
        types: [{
            type: "success", className: "notyf__toast--success", backgroundColor: "#3dc763", icon: {
                className: "notyf__icon--success", tagName: "i"
            }
        }, {
            type: "error", className: "notyf__toast--error", backgroundColor: "#ed3d3d", icon: {
                className: "notyf__icon--error", tagName: "i"
            }
        }], duration: 2e3, ripple: !0, position: {
            x: "right", y: "bottom"
        }, dismissible: !((i = m = m || {
        })[i.Dismiss = 0] = "Dismiss")
        ...
        for (var i = -1, n = 0;
            n < this.notifications.length && i < 0;
            n++)this.notifications[n].notification === t && (i = n);
        ...
        var i = this.X_POSITION_FLEX_MAP[this.getXPosition(t)], n = this.Y_POSITION_FLEX_MAP[this.getYPosition(t)], e = this.container.style;
        ...
        var o = this._createHTLMElement({
            tagName: "div", className: "notyf__toast"
        }), s = this._createHTLMElement({
            tagName: "div", className: "notyf__ripple"
        }), a = this._createHTLMElement({
            tagName: "div", className: "notyf__wrapper"
        }), r = this._createHTLMElement({
            tagName: "div", className: "notyf__message"
        });
        ...
        if (e && "object" == typeof e) {
            ...
            var p = this._createHTLMElement({
                ...
                tagName: e.tagName || "i", className: e.className, text: e.text
            });
        ...
        var t = this._createHTLMElement({
            tagName: "div", className: "notyf-announcer"
        });
        ...
        var t, i = document.createElement("_fake"), n = {
            MozTransition: "animationend", OTransition: "oAnimationEnd", WebkitTransition: "webkitAnimationEnd", transition: "animationend"
        };
    ...
    function p() {
        ...
        var t = document.createDocumentFragment(), i = this._createHTLMElement({
            tagName: "div", className: "notyf"
        });
        ...
        this.options = o(o({
        }, r), t), this.options.types = i, this.notifications.onUpdate(function (t, i) {
        ...
        return "string" == typeof i ? n.message = i : "object" == typeof i && (n = o(o({
        }, n), i)), n
